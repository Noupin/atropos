"""Authentication helpers for Instagram via the Meta Graph API."""
...
OAUTH_SCOPES = (
    "pages_show_list,instagram_content_publish,pages_read_engagement"
)


def _get_oauth_code(auth_url: str, state: str) -> tuple[str, str]:
    """Open ``auth_url`` and return the ``code`` once redirected back."""
