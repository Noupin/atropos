...
def _build_system_instructions(
    ...
    return (
        ...
        "  (rating is a decimal number with up to 1 decimal place within allowed range (e.g., 7.3, 9.0)).\n\n"
        "CLIP RULES:\n"
        ...
        "RATING SCALE:\n"
        "- Use these rating descriptions to decide scores. Ratings must be decimal with up to one decimal place (e.g., 8.4, 7.0).\n"
        f"GENERAL RATINGS:\n{GENERAL_RATING_DESCRIPTIONS}\n\n"
        f"SPECIFIC RATINGS (if applicable):\n{rating_descriptions if rating_descriptions else '(none)'}\n\n"
        "TONE-SPECIFIC:\n"
        f"{prompt_desc}\n\n"
